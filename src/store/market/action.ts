...
import { AgentsMarketItem, LuhuChatAgentsMarketIndex } from '@/types/market';
...
export interface StoreAction {
  ...
  useFetchAgentList: () => SWRResponse<LuhuChatAgentsMarketIndex>;
}
...
> = (set, get) => ({
  ...
  useFetchAgentList: () =>
    useSWR<LuhuChatAgentsMarketIndex>(
