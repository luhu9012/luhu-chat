...
Upgrading the Docker deployment version is very simple, just redeploy the latest image of LuhuChat. Here are the instructions to perform these steps:

1. Stop and delete the currently running LuhuChat container (assuming the name of the LuhuChat container is `lobe-chat`):
...
2. Pull the latest Docker image of LuhuChat:

```fish
docker pull lobehub/lobe-chat
```

3. Redeploy the LuhuChat container using the newly pulled image:
...
>
> Don't worry, all of LuhuChat's chat history is stored in your local browser. Therefore, when you redeploy LuhuChat using Docker, your chat history will not be lost.
