...
# Using Ollama in LuhuChat

<<<<<<< HEAD
<Image
  alt={'Using Ollama in LuhuChat'}
...
This document will guide you on how to use Ollama in LuhuChat:
...
<<<<<<< HEAD
Next, you can start conversing with the local LLM using LuhuChat.
...
<Callout type={'info'}>
  ...
  LuhuChat to meet the integration requirements with Ollama.
</Callout>
=======
