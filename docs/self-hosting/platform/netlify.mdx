...
# Deploy LuhuChat with Netlify
=======
# Deploy LobeChat with Netlify
>>>>>>> 0b1d4cdbdee0241b3965a4c86ef4bcddb0c3fbd9

If you want to deploy LuhuChat on Netlify, you can follow these steps:
...
<<<<<<< HEAD
### Fork the LuhuChat Repository

Click the Fork button to fork the LuhuChat repository to your GitHub account.
=======
...
Next, select the LuhuChat project:

<Image
  alt={'Select the LuhuChat github project'}
...
<Image
  alt={'Configure LuhuChat site name'}
...
<Image
  alt={'Add LuhuChat site environment variables'}
...
<Callout type={'info'}>
  For a complete list of environment variables supported by LuhuChat, please refer to the [📘
  Environment Variables](/en/self-hosting/environment-variables)
</Callout>
...
Upon entering the deployment details, you will see the following interface, indicating that your LuhuChat is currently being deployed. Simply wait for the deployment to complete.

<Image
  alt={'LuhuChat deployment in progress'}
...
If your Deploy Log in the interface looks like the following, it means your LuhuChat has been successfully deployed.
...
<Image
  ...
  height={558}
/>
At this point, you can click on "Open production deploy" to access your LuhuChat site.

<Image
  alt={'Access Your LuhuChat Site'}
